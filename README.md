...
- **Select** (center) — enter/leave spotlight mode. While picking, click a page
  ...
  spotlight several at once as a group; click a spotlit element again to remove
